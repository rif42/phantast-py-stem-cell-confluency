# Phantast Lab User Flows

Based on the product overview and the core architecture of Phantast Lab, here are the primary user flows broken down into distinct phases of work.
...
*Optional Step:* The user saves this perfected Pipeline Stack configuration to a template file so the lab can standardize on this protocol.
